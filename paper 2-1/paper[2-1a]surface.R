...
create_surface_data <- function(C, Cp_min, Cp_max) {
  ...
  # 生成網格數據
  Cp_values <- seq(Cp_min, Cp_max, length.out = 50)  # Cp值序列
  n_values <- seq(30, 300, length.out = 50)          # 樣本數序列
  # 計算每個網格點的c0值
...
# 設定所有圖形的參數
C_values <- c(1.00, 1.33, 1.50, 1.67, 2.00)  # Cpk值
Cp_ranges <- list(  # 每個圖的Cp範圍
  c(1.00, 2.00),
  c(1.33, 2.33),
  c(1.50, 2.50),
  c(1.67, 2.67),

function c0 = calculate_c0_lsqnonlin(C, Cp, n, alpha)
    ...
    [c0, resnorm, residual, exitflag] = lsqnonlin(@(x) objective_function(x, C, Cp, n, alpha), x0, [], [], options);
    ...
    if exitflag > 0
        ...
        error('lsqnonlin did not converge to a solution.');
    end
end
...
c0 = calculate_c0_lsqnonlin(C, Cp, n, alpha);
...
# 設定參數值範圍
C_values <- c(1.00, 1.33, 1.5, 1.67, 2.00)  # Cpk 要求值
n_values <- seq(10, 405, by = 5)  # 樣本數範圍，從 10 到 405，每隔 5 取一值
alpha_values <- c(0.01, 0.025, 0.05)  # 顯著水準 alpha
...
for (C in C_values) {
  ...
  print(kable(table_df, col.names = c("n", "α = 0.01", "α = 0.025", "α = 0.05"),
              caption = paste("Critical value c0 for C = ", C, ", n = 10(5)230, α = 0.01, 0.025, 0.05"),
              align = 'r', digits = 3))
}
